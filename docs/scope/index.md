...
| 7   | About and resume page           | Visitor journey | existing    |
| 8   | Services page                   | Visitor journey | existing    |
| 9   | Project discovery               | Visitor journey | existing    |
| 10  | Project case study              | Visitor journey | existing    |
| 11  | Contact journey                 | Visitor journey | in-progress |
...
[Visitor journey](visitor.md): 1 feature is done, 4 are existing, 2 are in progress, and 0 are planned. Together they let a hiring manager understand the owner, inspect relevant work, download a resume, and make contact.
